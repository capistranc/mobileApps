...
//        print("keyboardFrame:", keyboardFrame.size)
//        print("keyboardFrame:", keyboardFrame)
//        print("originalConstraint:", originalConstraintValue)
//        animateThis(to: keyboardFrame.size.height, duration: duration)
    ...
    func animateThis(to height:CGFloat, duration: Double){
        ...
        UIView.animate(withDuration: duration) {
            ...
            let offset = CGPoint(x: 0.0, y: self.scrollView.contentSize.height - self.scrollView.bounds.size.height)
